    ...
    <div className="flex items-center gap-2 px-4 py-2">
      ...
      >
        {expired
          ...
          : expiring
          ? `Expiring soon · ${days} day${days === 1 ? "" : "s"} left`
